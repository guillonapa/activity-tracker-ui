...
public interface UserApi {
    ...
    ResponseEntity<Void> userDelete(@ApiParam(value = "unique user identifier") @Valid @RequestParam(value = "userId", required = false) String userId
);


    @ApiOperation(value = "gets user preferences", nickname = "userGet", notes = "", response = UserBaseReqBody.class, tags={ "developers", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "user was found", response = UserBaseReqBody.class),
        @ApiResponse(code = 400, message = "user id not found") })
    @RequestMapping(value = "/user",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<UserBaseReqBody> userGet(@NotNull @ApiParam(value = "unique user identifier", required = true) @Valid @RequestParam(value = "userId", required = true) String userId
);
    ...
    ResponseEntity<Void> userPut(@ApiParam(value = "user account details to update"  )  @Valid @RequestBody UserUpdateReqBody body
);
